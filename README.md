...
This project was developed as part of the Integrated Project course with a focus on Computer Vision.

The goal is to present a complete, modular pipeline for football video analysis, serving as a practical example of how to structure computer vision projects for production.

Main Features

Object detection with YOLO (players, ball, referee)
Multi-Object Tracking (MOT)
Keypoint detection for pose analysis
Player clustering with ReID (re-identification)
Tactical analysis using homography
...
![finaloutput](output/finaloutput.jpg)
